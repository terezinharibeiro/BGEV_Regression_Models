...
sink("Results_Scenario7.txt")

names_results1 <- c("Estimates_Scenario7_n50", "Estimates_Scenario7_n100", "Estimates_Scenario7_n500")
names_results2 <- c("SE_Estimates_Scenario7_n50", "SE_Estimates_Scenario7_n100", "SE_Estimates_Scenario7_n500")
...
fitgumbel <-  suppressWarnings(vglm(y~x1+x2, gumbelff(perc = NULL))) #starting values via Gumbel regression
...
cat(" TRUE VALUES ","\n")
cat(" Sample size ",N ,"\n")
out_VTHETA2 <- rbind(VTHETA2);colnames(out_VTHETA2)=c("beta1", "beta2", "beta3", "sigma", "delta");rownames(out_VTHETA2)=c("");print(out_VTHETA2)
...
output_mle = rbind(out_estimates_MLE);colnames(output_mle)=c("Mean estimates","Bias","RMSE", "Mean SE");rownames(output_mle)=c("beta1", "beta2", "beta3", "sigma", "delta");print(output_mle)
cat(" ========================================================================================== \n")
